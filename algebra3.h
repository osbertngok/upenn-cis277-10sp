...
// Extra functions by Osbert Ngok
friend vec3 ratio(const vec3& a, const vec3& b, double Ratio);
friend vec3 normal(const vec3& a, const vec3& b, const vec3& c);
...
mat4 rotation3D(const vec3& AxisPara, const double angleDeg, const vec3& backup);	    // rotation 3D
